...
# Project Description
This tool is about an auto-correction, that receives as arguments the name of a file containing a text that needs some modifications (input) and the name of the file the modified text should be placed in (the output)
...
# General information
   This tool is  written  in Go-language and specifically used to solve the following after receiving arguments through the terminal: 
